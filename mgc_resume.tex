...
% Again, the address lines must be centered over entire width of resume:
 \moveleft.5\hoffset\centerline{1731 Bishop Road}
 \moveleft.5\hoffset\centerline{Blacksburg, VA 24060}
...
\item Technologies: AWS, Redis, MySQL, RabbitMQ, memcached, Jenkins, git
\end{itemize}
...
\begin{flushleft}
{\bf Principal Software Engineer at Motorola Solutions, July 2020 to present, remote)
\end{flushleft}
...
\begin{flushleft}
{\bf Software Development Manager at Rackspace, March 2019 to July 2020, Blacksburg, Virginia}
\end{flushleft}
